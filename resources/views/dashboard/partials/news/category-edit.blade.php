                ...
                <form action="{{route('category.update' , $category->id)}}" method="post">
                 ...
                 <div class="row">
                     <div class="col-sm-12 col-md-4">
                         ...
                         <input name="name" type="text" class="form-control @error('name') border-danger @enderror" placeholder="نام دست بندی ..." value="{{$category->name}}">
                         @error('name')
                     ...
                     <div class="col-sm-12 col-md-4">
                         ...
                         <input name="slug" type="text" class="form-control @error('slug') border-danger @enderror" placeholder="  نامک ..." value="{{$category->slug}}">
                         @error('slug')
                         <small class="mt-2 d-inline-block text-danger">{{$message}}</small>
                         @enderror
                     </div>
